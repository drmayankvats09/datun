// apps/web/app/[locale]/(auth)/login/layout.tsx
// ═══════════════════════════════════════════════════════════════
// LOGIN — metadata shell (Task #53.5 W3 hotfix-2)
//
...
// own the SEO head for /login: title + per-locale canonical + the
...
export async function generateMetadata({
  ...
  return {
    title: 'Log in',
    description: 'Log in to your Datun account.',
